/* Verilog netlist generated by SCUBA Diamond (64-bit) 3.3.0.107 */
/* Module Version: 1.2 */
/* C:\lscc\diamond\3.3_x64\ispfpga\bin\nt64\scuba.exe -w -n spi_slave_efb -lang verilog -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 50 -spi -spi_mode Slave -spi_rxr -spi_en -wb -dev 1200  */
/* Thu Oct 16 14:43:11 2014 */
...
module spi_slave_efb (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, 
    ...
    defparam EFBInst_0.EFB_WB_CLK_FREQ = "66.5" ;
    EFB EFBInst_0 (.WBCLKI(wb_clk_i), .WBRSTI(wb_rst_i), .WBCYCI(wb_cyc_i), 
        ...
        .SPICSNEN(), .SPIIRQO(), .TCINT(), .TCOC(), .WBCUFMIRQ(), 
        .CFGWAKE(), .CFGSTDBY());
